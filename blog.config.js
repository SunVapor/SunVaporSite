...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SunVapor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个CS本科生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sunvapor.site/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CS,博客', // 网站关键词 英文逗号隔开
